...
import { QqOutlined, SettingOutlined, VerifiedOutlined, DeleteOutlined, LoginOutlined, ArrowRightOutlined, MessageOutlined, CheckOutlined, QrcodeOutlined, PictureOutlined } from '@ant-design/icons'
                ...
                <Row gutter={24}>
                    ...
                    <Col offset={0} span={14} style={{ textAlign: "left", fontSize: "16px" }}>
                        ...
                        <div style={{ height: "30px" }}>
                            ...
                            {!!captcha && captcha.captchaType == dto.Bot.Captcha.CaptchaType.UNSAFE_DEVICE_LOGIN_VERIFY && (<span>设备锁<LoginOutlined style={{ marginLeft: "8px" }} /></span >)}
                        </div>
                    </Col>
                </Row>
            </Card>
